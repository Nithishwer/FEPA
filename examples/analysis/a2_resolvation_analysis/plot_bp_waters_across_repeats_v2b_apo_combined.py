...
def main():
    ...
    for cmp in ["apo"]:
        ...
        sns.lineplot(data=features_df, x="Time (ps)", y="occupancy", hue="ensemble")
        ...
        plt.savefig(
            os.path.join(
                cmp_output_dir, f"{cmp}_water_occupancy_combined_timeseries_v2.png"
            )
        )
        ...
        # plt.legend(
        #     title="Vanilla Repeat", title_fontsize=12, fontsize=10, loc="upper right"
        # )
