...
def compile_abfeapo_jsd_ddG_df(
    ...
    for cmp in compounds_filtered:
        for van in [1, 2, 3]:
            ...
            # Get the jsd
            jsd_df = pd.read_csv(
                f"/biggin/b211/reub0138/Projects/orexin/christopher_et_al_v1/analysis/a8_abfe_overlap_apo_analysis/wdir/combined_PC_analysis/combined_entropy_matrix.csv",
                index_col=0,
            )
...
def main():
    ...
    analysis_output_dir = os.path.join("wdir", "combined_PC_analysis")
