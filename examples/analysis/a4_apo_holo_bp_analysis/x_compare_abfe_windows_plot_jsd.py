...
def main():
    ...
    existing_run_dir = os.path.join(
        '/biggin/b211/reub0138/Projects/orexin/christopher_et_al_v1/analysis/a1_binding_pocket_analysis/a1_binding_pocket_analysis/wdir')
    ...
    for cmp in config["compounds"][1:]:
        ...
        cmp_existing_run_dir = os.path.join(existing_run_dir, cmp)
        ...
        featurizer.load_features(input_dir=cmp_existing_run_dir)
